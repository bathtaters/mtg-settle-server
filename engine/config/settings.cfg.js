...
const updateRootPath = (staticRootPath) => {
  ...
  module.exports.definitions.DB_DIR.tooltip =
    module.exports.definitions.DB_DIR.tooltip.replace(
      regex.path,
      module.exports.definitions.DB_DIR.default,
    );
  module.exports.definitions.LOG_DIR.tooltip =
    module.exports.definitions.LOG_DIR.tooltip.replace(
      regex.path,
      module.exports.definitions.LOG_DIR.default,
    );
  module.exports.definitions.DB_DIR.default =
    module.exports.definitions.DB_DIR.default.replace(
      regex.root,
      staticRootPath + "/",
    );
  module.exports.definitions.LOG_DIR.default =
    module.exports.definitions.LOG_DIR.default.replace(
      regex.root,
      staticRootPath + "/",
    );
};
...
module.exports = {
  ...
  definitions: {
    NODE_ENV: {
      default: "development",
      html: {
        type: ["development", "production", "secure-dev"],
    ...
    LOG_HTTP: {
      default: "common",
      html: {
        type: ["none", "tiny", "short", "dev", "common", "combined", "debug"],
      },
    ...
    TRUST_PROXY: {
      ...
      tooltip:
        'Trust-Proxy setting. Can be number of hops, true/false for last/first, "loopback" or specifc domains (comma seperated).',
    },
    SESSION_SECRET: {
      default: "secret",
      html: { type: "password", limits: { min: 4, max: 2048 } },
      tooltip:
        "Secret phrase for user sessions (Changing will logout all users)",
    },
    DB_SECRET: {
      default: "secret",
      html: { type: "password", readonly: true, limits: { min: 4, max: 2048 } },
      tooltip:
        "Secret phrase for database (WARNING: Changing requires all dbs/users reset)",
    },
    DB_DIR: {
      default: "./.db",
    ...
    METRICS: {
      default: "",
      html: { type: "url", limits: { min: 0, max: 2048 } },
      tooltip: "URL for server displaying metrics",
    },
  },
  ...
  escapeEnvMsg: (char, idx, val) =>
    `Stripping illegal character '${char}' from "${val}" [${idx}]`,
};
