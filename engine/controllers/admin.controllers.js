...
const { base, config, modelsPath } = require("../src.path");
...
exports.userTable = modelDb(Users, {
  view: "users",
...
exports.logList = (req, res, next) =>
  logList()
    .then((logs) => {
      const isAdmin = req.user && hasAccess(req.user.access, access.admin);
      return res.render("logList", {
        title: "Logs",
        logs,
        baseURL: logBaseURL + "/",
        user: req.user && req.user.username,
